package com.md.scheduler.job.core.glue.impl;

import com.md.scheduler.job.core.executor.impl.JobSpringExecutor;
import com.md.scheduler.job.core.glue.GlueFactory;
            ...
            if (AnnotationUtils.getAnnotation(field, Resource.class) != null) {
                try {
                    ...
                    if (resource.name() != null && resource.name().length() > 0) {
                        fieldBean = JobSpringExecutor.getApplicationContext().
